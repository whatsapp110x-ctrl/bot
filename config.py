...
BOT_TOKEN = "8007887534:AAGeHkGhMXaZMefhm0ux2llPXMX5Mgb2u2E"   # set via BOT_TOKEN environment secret
...
# Auto-detect Replit domain for testing when STREAM_BASE_URL is not set
if not STREAM_BASE_URL:
    _replit_domain = _env("REPLIT_DOMAINS")
    if _replit_domain:
        # Replit exposes all ports on the same domain; port 8765 is accessible
        STREAM_BASE_URL = f"https://{_replit_domain}:{STREAM_PORT}"
